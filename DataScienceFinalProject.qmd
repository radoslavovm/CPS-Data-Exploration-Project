...
census_api_key("4b11e9f5d9ac286e1a22800c7e56fc771229ec6a", install = TRUE, overwrite = TRUE)
```
...
# Map for Poverty
ggplot(map_data) +
  geom_sf(aes(fill = percent_poverty), color = "white", size = 0.2) +
...
```{r MapforBachelorsDegree}
# Map for Bachelors Degree
ggplot(map_data) +
  geom_sf(aes(fill = percent_bachelors), color = "white", size = 0.2) +
  scale_fill_viridis_c(option = "plasma") +
  labs(
...
```{r MapforUnemployment}
# Map for Unemployment 
ggplot(map_data) +
  geom_sf(aes(fill = percent_unemployed), color = "white", size = 0.2) +
  scale_fill_viridis_c(option = "plasma") +
  labs(
...
```{r ForeignBornPopulationMap}
# Map for Foreign-Born Population
ggplot(map_data) +
  geom_sf(aes(fill = percent_foreign_born), color = "white", size = 0.2) +
  scale_fill_viridis_c(option = "plasma") +
  labs(
...
```{r NativeBornPopulationMap}
ggplot(map_data) +
  geom_sf(aes(fill = percent_native_us), color = "white", size = 0.2) +
  scale_fill_viridis_c(option = "plasma") +
  labs(
...
```{r InternetSubscriptionMap}
# Map for Internet Subscription
ggplot(map_data) +
  geom_sf(aes(fill = percent_internet), color = "white", size = 0.2) +
  scale_fill_viridis_c(option = "plasma") +
  labs(
...
```{r LongCommutetoWorkMap}
# Map for Long Commute
ggplot(map_data) +
  geom_sf(aes(fill = percent_long_commute), color = "white", size = 0.2) +
  scale_fill_viridis_c(option = "plasma") +
  labs(
...
```{r OwnerOccupiedHouseMap}
# Owning House Map
ggplot(map_data) +
  geom_sf(aes(fill = percent_owner_occupied), color = "white", size = 0.2) +
  scale_fill_viridis_c(option = "plasma") +
  labs(
...
```{r MarriedCoupleFamiliesMap}
# Married-Couple Family Map
ggplot(map_data) +
  geom_sf(aes(fill = percent_married_family), color = "white", size = 0.2) +
  scale_fill_viridis_c(option = "plasma") +
  labs(
